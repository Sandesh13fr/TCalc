...
class GenerateAgentRulesAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        try {
            ...
            val result = runner.generateAgentRules(project.basePath ?: return)
            ...
            val outputFile = File(project.basePath, "AGENTS.md")
