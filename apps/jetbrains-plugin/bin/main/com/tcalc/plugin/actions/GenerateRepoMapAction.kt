...
class GenerateRepoMapAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        try {
            ...
            val result = runner.generateRepoMap(project.basePath ?: return)
            ...
            val outputFile = File(project.basePath, "REPO_MAP.md")
