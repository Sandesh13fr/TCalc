...
describe("recommendModels", () => {
  ...
  it("rejects models whose output limit is below the expected output", () => {
    ...
    expect(result.allScored.find((m) => m.modelId === "output-limited")?.overflowRisk).toBeGreaterThan(0);
  });
  ...
  it("rejects invalid output token counts while allowing zero", () => {
